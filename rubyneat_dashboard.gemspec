...
# -*- encoding: utf-8 -*-
# stub: rubyneat_dashboard 0.4.0alpha.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.files = [
    ...
    "app/js/dashboard/critters_controller.coffee",
    "app/js/dashboard/dashboard_controller.coffee",
    "app/js/dashboard/home_controller.coffee",
    "app/js/dashboard/overview_controller.coffee",
    "app/js/dashboard/population_controller.coffee",
